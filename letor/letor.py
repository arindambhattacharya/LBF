...
# pickle.dump(model, open('models/letor.model', 'wb'))
# print(model.score(X_test_init, Y_test_init))
# exit()
...
# # model = pickle.load(open('models/letor.model', 'rb'))
...
# outfile = open('outputs/letor_ialbf_run1.txt', 'w')
...
# # outfile = open('outputs/fb_calbf1_run3.txt', 'w')
# outfile = open('outputs/fb_calbf2_run3.txt', 'w')

# start = time.time()

# my_bc.initialize(X_init, Y_init, m=8500)
...
outfile = open('outputs/letor_base_run1.txt', 'w')
